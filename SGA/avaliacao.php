...
<div class='wrapper'>
    ...
    <div class='main-panel'>
        ...
        if (isset($_REQUEST["act"]) && $_REQUEST["act"] == "upd" && $id != "") {
            try {
                $statement = $pdo->prepare("SELECT idAvaliacao, Curso_idCurso, Turma_idTurma, Aluno_idAluno, Nota1, Nota2
                        ...
                        <div class='card'>
                            ...
                            <div class='content table-responsive'>
                                ...
                                <form action="?act=save" method="POST" name="form1" >
                                    ...
                                    Nota 1:
                                    <input type="text" size="10" name="nota1" value="<?php
                                    // Preenche o nome no campo nome com um valor "value"
                                    echo (isset($nota1) && ($nota1 != null || $nota1 != "")) ? $nota1 : '';
                                    ?>" />
                                    <br>
                                    Nota 2:
                                    <input type="text" size="10" name="nota2" value="<?php
                                    // Preenche o nome no campo nome com um valor "value"
                                ...
                                <?php
                                if (isset($_REQUEST["act"]) && $_REQUEST["act"] == "save" && $curso != "") {
                                    try {

                                        if ($id != "") {
                                            $statement = $pdo->prepare("UPDATE Avaliacao SET Curso_idCurso=:curso, Turma_idTurma=:turma, Aluno_idAluno=:aluno,
                                             Nota1=:nota1, Nota2=:nota2 WHERE idAvaliacao =:id;");
                                            $statement->bindValue(":id", $id);
                                        } else {
                                            $statement = $pdo->prepare("INSERT INTO Avaliacao (Curso_idCurso, Turma_idTurma, Aluno_idAluno, Nota1, Nota2) 
                                              VALUES (:curso, :turma, :aluno, :nota1, :nota2)");
